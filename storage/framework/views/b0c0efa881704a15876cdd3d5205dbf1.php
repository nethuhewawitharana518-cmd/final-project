<?php $__env->startSection('title', 'Business Profile Settings'); ?>
...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1">
        ...
        <div class="content-area">
            <form action="<?php echo e(route('business.profile.update')); ?>" method="POST" enctype="multipart/form-data">
                <?php echo csrf_field(); ?>
...
unset($__errorArgs, $__bag); ?>" id="business_name" name="business_name" value="<?php echo e(old('business_name', $business->business_name)); ?>" required>
...
unset($__errorArgs, $__bag); ?>" id="business_type" name="business_type" required>
                                        <option value="hotel" <?php echo e(old('business_type', $business->business_type) == 'hotel' ? 'selected' : ''); ?>>🏨 Hotel / Resort</option>
                                        <option value="restaurant" <?php echo e(old('business_type', $business->business_type) == 'restaurant' ? 'selected' : ''); ?>>🍽️ Restaurant</option>
                                        <option value="bakery" <?php echo e(old('business_type', $business->business_type) == 'bakery' ? 'selected' : ''); ?>>🥐 Bakery</option>
                                        <option value="cafe" <?php echo e(old('business_type', $business->business_type) == 'cafe' ? 'selected' : ''); ?>>☕ Cafe</option>
                                        <option value="supermarket" <?php echo e(old('business_type', $business->business_type) == 'supermarket' ? 'selected' : ''); ?>>🛒 Supermarket / Grocery</option>
                                    </select>
...
unset($__errorArgs, $__bag); ?>" id="phone" name="phone" value="<?php echo e(old('phone', $business->phone)); ?>" maxlength="10" placeholder="e.g., 0771234567" required pattern="^07[0-9]{8}$"
...
unset($__errorArgs, $__bag); ?>" id="email" name="email" value="<?php echo e(old('email', $business->email)); ?>">
...
unset($__errorArgs, $__bag); ?>" id="description" name="description" rows="3" placeholder="Tell customers about your brand or food rescue initiatives..."><?php echo e(old('description', $business->description)); ?></textarea>
                            ...
                            <div class="mb-3">
                                ...
                                <div class="d-flex align-items-center gap-3">
                                    <?php if($business->logo): ?>
                                        <img src="<?php echo e(asset('storage/' . $business->logo)); ?>" alt="Logo preview" class="img-logo-preview">
                                    <?php else: ?>
...
unset($__errorArgs, $__bag); ?>" id="logo" name="logo" accept="image/jpeg,image/png">
...
unset($__errorArgs, $__bag); ?>" id="address" name="address" value="<?php echo e(old('address', $business->address)); ?>" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="row mb-3">
                                <div class="col-6">
                                    ...
                                    <input type="text" class="form-control bg-light" id="latitude" name="latitude" value="<?php echo e(old('latitude', $business->latitude)); ?>" readonly placeholder="Click map to pick">
                                </div>
                                <div class="col-6">
                                    <label for="longitude" class="form-label fw-semibold text-secondary small">Longitude (GPS Coords)</label>
                                    <input type="text" class="form-control bg-light" id="longitude" name="longitude" value="<?php echo e(old('longitude', $business->longitude)); ?>" readonly placeholder="Click map to pick">
                                </div>
                            </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/business/profile.blade.php ENDPATH**/ ?>