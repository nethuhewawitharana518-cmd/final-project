...
<?php $__env->startSection('meta_description', 'Login to your FoodRescue account to browse discounted surplus food deals or manage your business listings in Trincomalee.'); ?>
...
unset($__errorArgs, $__bag); ?>
                        ...
                        <div class="mb-4">
                            <div class="d-flex justify-content-between align-items-center mb-1">
                                ...
                                <a href="<?php echo e(route('password.request')); ?>" class="text-primary small text-decoration-none">Forgot Password?</a>
                            </div>
                            <div class="input-group shadow-sm">
                                <span class="input-group-text bg-white border-end-0 text-muted"><i class="fa fa-lock"></i></span>
                                <input type="password" name="password" id="password" class="form-control border-start-0 ps-0 <?php $__errorArgs = ['password'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="text-center mt-3">
                        ...
                        <a href="<?php echo e(route('register')); ?>" class="text-primary small fw-semibold text-decoration-none">Sign Up Here</a>
                    </div>
                </div>
            </div>
        </div>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/auth/login.blade.php ENDPATH**/ ?>