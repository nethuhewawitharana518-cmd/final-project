<?php $__env->startSection('title', 'Self Pick-up Route — ' . $vendorName); ?>
<?php $__env->startSection('meta_description', 'Navigate to ' . $vendorName . ' for your self pick-up order. Live routing and turn-by-turn directions powered by OpenStreetMap.'); ?>
...
<div class="pickup-wrapper">
    ...
    <div class="pickup-hero">
        <div>
            ...
            <p>Order #<?php echo e($order->reservation_code); ?> &bull; <?php echo e($vendorName); ?></p>
        </div>
        <div class="d-flex gap-2 ms-auto flex-wrap">
            <span class="pup-chip"><span class="dot"></span>Live GPS</span>
            <a href="<?php echo e(route('customer.orders.show', $order->id)); ?>" class="btn btn-outline-light btn-sm px-3 rounded-pill">
        ...
        <div class="pickup-panel">
            ...
            <div class="panel-section">
                ...
                <div class="info-row">
                    ...
                    <span><strong><?php echo e($vendorName); ?></strong><?php echo e($vendorAddress); ?></span>
                </div>
                <?php if($vendorPhone): ?>
                <div class="info-row">
                    <i class="fa fa-phone"></i>
                    <span><a href="tel:<?php echo e($vendorPhone); ?>" style="color:#10b981;"><?php echo e($vendorPhone); ?></a></span>
                </div>
                <?php endif; ?>
                <?php if($pickupTime): ?>
                <div class="info-row">
                    <i class="fa fa-clock"></i>
                    <span><strong>Pick-up Time</strong><?php echo e($pickupTime); ?></span>
                </div>
                <?php endif; ?>
                <a href="https://www.google.com/maps/dir/?api=1&destination=<?php echo e($vendorLat); ?>,<?php echo e($vendorLng); ?>"
...
<script>
// ── Constants ──────────────────────────────────────────────────────────────────
const VENDOR_LAT  = <?php echo e($vendorLat); ?>;
const VENDOR_LNG  = <?php echo e($vendorLng); ?>;
const VENDOR_NAME = <?php echo json_encode($vendorName, 15, 512) ?>;
...
const vendorMarker = L.marker([VENDOR_LAT, VENDOR_LNG], { icon: vendorIcon })
    ...
    .bindPopup(`
        <div style="font-family:sans-serif;min-width:160px;">
            ...
            <p style="margin:4px 0 0;font-size:11px;color:#555;"><?php echo e($vendorAddress); ?></p>
        </div>
    `, { maxWidth: 220 })
    .openPopup();
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/customer/pickup-map.blade.php ENDPATH**/ ?>