<?php $__env->startSection('title', 'Food Rescue Map — Trincomalee'); ?>
<?php $__env->startSection('meta_description', 'Find surplus food deals near you in Trincomalee. Interactive map showing all partner hotels, restaurants, bakeries and cafes with live food deals.'); ?>
...
<div class="map-page-wrapper">
    ...
    <div class="map-hero-bar">
        ...
        <div class="map-stat-chip">
            <span class="dot"></span>
            <?php echo e($merchants->count()); ?> Partner<?php echo e($merchants->count() != 1 ? 's' : ''); ?> on Map
        </div>
        <a href="<?php echo e(route('food.browse')); ?>" class="btn btn-sm btn-outline-light rounded-pill px-3" style="font-size:.8rem; border-color:rgba(255,255,255,.3);">
        ...
        <div class="map-sidebar" id="mapSidebar">
            ...
            <div class="sidebar-list" id="bizList">
                <?php $__empty_1 = true; $__currentLoopData = $merchants; $__env->addLoop($__currentLoopData); foreach($__currentLoopData as $merchant): $__env->incrementLoopIndices(); $loop = $__env->getLastLoop(); $__empty_1 = false; ?>
                    <div class="biz-item" id="item-<?php echo e($merchant->id); ?>" onclick="focusBusiness(<?php echo e($merchant->id); ?>, <?php echo e($merchant->latitude); ?>, <?php echo e($merchant->longitude); ?>)">
                        <div class="biz-icon">
                            <?php if($merchant->business_type == 'hotel'): ?> 🏨
                            <?php elseif($merchant->business_type == 'restaurant'): ?> 🍽️
                            <?php elseif($merchant->business_type == 'bakery'): ?> 🥐
                            <?php elseif($merchant->business_type == 'cafe'): ?> ☕
                            <?php else: ?> 🛒 <?php endif; ?>
                        </div>
                        <div style="min-width:0;">
                            <p class="biz-name"><?php echo e($merchant->business_name); ?></p>
                            <p class="biz-addr"><?php echo e($merchant->address); ?></p>
...
<?php $__env->startPush('scripts'); ?>
        <script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps_key')); ?>&libraries=geometry,places&callback=initMap" async defer></script>
...
function initMap() {
    ...
    const merchants = <?php echo json_encode($merchants, 15, 512) ?>;
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/public/map.blade.php ENDPATH**/ ?>