<?php $__env->startSection('title', 'Select Account Type'); ?>
<?php $__env->startSection('meta_description', 'Choose your FoodRescue account type — Sign up as a customer to buy deals or register your business to list food surplus.'); ?>
        ...
        <div class="row g-4 justify-content-center">
            ...
            <div class="col-md-5">
                <div class="card h-100 border-0 shadow-lg p-5 text-center bg-white rounded-3 hover-translate-y transition-all">
                    ...
                    <a href="<?php echo e(route('register.customer')); ?>" class="btn btn-success w-100 rounded-pill fw-semibold py-3 shadow-sm mt-auto">
            ...
            <div class="col-md-5">
                <div class="card h-100 border-0 shadow-lg p-5 text-center bg-white rounded-3 hover-translate-y transition-all">
                    ...
                    <a href="<?php echo e(route('register.business')); ?>" class="btn btn-outline-success w-100 rounded-pill fw-semibold py-3 shadow-sm mt-auto">
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/auth/register.blade.php ENDPATH**/ ?>