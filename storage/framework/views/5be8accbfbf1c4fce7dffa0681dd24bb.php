            ...
            <div class="col-lg-6">
                ...
                <div class="card border-0 shadow-sm p-4 bg-light h-100 rounded-3">
                    <div class="d-flex align-items-center gap-3 mb-3">
                        <?php if($food->business->logo): ?>
                            <img src="<?php echo e(asset('storage/' . $food->business->logo)); ?>" alt="<?php echo e($food->business->business_name); ?>" class="rounded-circle border border-2 border-success" style="width: 56px; height: 56px; object-fit: cover;">
                        <?php else: ?>
                            <div class="d-flex align-items-center justify-content-center rounded-circle border border-2 border-success fw-bold text-white" style="width: 56px; height: 56px; background: var(--primary); font-size: 1.4rem;">
                                <?php echo e(strtoupper(substr($food->business->business_name, 0, 1))); ?>

                            </div>
                        <?php endif; ?>
                        <div>
                            <h5 class="fw-semibold text-success mb-0"><?php echo e($food->business->business_name); ?></h5>
                            <span class="badge bg-success-subtle text-success text-capitalize small mt-1"><i class="fa fa-store me-1"></i><?php echo e($food->business->business_type); ?></span>
                        </div>
                    </div>
        ...
        <div class="row mt-5 pt-3 border-top">
            <div class="col-12 d-flex align-items-center justify-content-between mb-4">
                ...
                <div class="text-warning fw-bold">
                    <?php if($food->business->review_count > 0): ?>
                        ⭐ <?php echo e(number_format($food->business->average_rating, 1)); ?> / 5.0 
                        <span class="text-muted small fw-normal">(<?php echo e($food->business->review_count); ?> Reviews)</span>
                    <?php endif; ?>
                </div>
            </div>
            <div class="col-12">
                                ...
                                <div class="card-body p-3">
                                    <div class="d-flex justify-content-between align-items-center mb-2">
                                        <div class="d-flex align-items-center gap-2">
                                            ...
                                            <div class="fw-bold text-dark"><?php echo e($review->customer->name ?? 'Anonymous Customer'); ?></div>
                                        </div>
                                    ...
                                    <?php if($review->comment): ?>
                                        <p class="text-dark small mb-2 ms-5" style="line-height: 1.5; font-style: italic;">"<?php echo e($review->comment); ?>"</p>
                                    <?php endif; ?>
                                    <div class="text-secondary ms-5" style="font-size: 0.7rem;"><i class="fa fa-clock me-1"></i><?php echo e($review->created_at->diffForHumans()); ?></div>
                                </div>
                            </div>
...
<script src="https://maps.googleapis.com/maps/api/js?key=<?php echo e(config('services.google_maps_key')); ?>&libraries=geometry,places&callback=initFoodMap" async defer></script>
<script>
