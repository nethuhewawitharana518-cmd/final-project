<?php $__env->startSection('title', 'Earnings Ledger'); ?>
...
<div class="d-flex">
    ...
    <div class="main-content flex-grow-1">
        <div class="page-header">
            ...
            <a href="<?php echo e(route('business.earnings.export')); ?>" class="btn btn-success btn-sm px-3">
        ...
        <div class="content-area text-start">
            ...
            <div class="row g-4 mb-5">
                <div class="col-md-4">
                    <div class="kpi-card bg-white h-100">
                        ...
                        <div>
                            <div class="kpi-value">Rs. <?php echo e(number_format($totalSales)); ?></div>
                ...
                <div class="col-md-4">
                    <div class="kpi-card bg-white h-100">
                        ...
                        <div>
                            <div class="kpi-value">Rs. <?php echo e(number_format($totalCommission)); ?></div>
                ...
                <div class="col-md-4">
                    <div class="kpi-card bg-white h-100">
                        ...
                        <div>
                            <div class="kpi-value">Rs. <?php echo e(number_format($totalEarnings)); ?></div>
                    ...
                    <div class="table-responsive">
                        <table class="table fr-table mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td>#<?php echo e($comm->reservation_id); ?></td>
                                    <td><?php echo e($comm->created_at->format('M d, Y H:i')); ?></td>
                                    <td class="fw-bold text-dark">Rs. <?php echo e(number_format($comm->sale_amount)); ?></td>
                                    <td class="text-danger">Rs. <?php echo e(number_format($comm->commission_amount)); ?></td>
                                    <td class="fw-bold text-success">Rs. <?php echo e(number_format($comm->business_earnings)); ?></td>
                                    <td>
            ...
            <div class="mt-4">
                <?php echo e($commissions->links('pagination::bootstrap-5')); ?>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/business/earnings.blade.php ENDPATH**/ ?>