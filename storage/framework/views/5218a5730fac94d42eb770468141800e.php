...
<?php $__env->startSection('meta_description', 'Get in touch with the FoodRescue team. Send us your feedback, questions, or business inquiries in Trincomalee.'); ?>
...
unset($__errorArgs, $__bag); ?>" value="<?php echo e(old('name')); ?>" placeholder="John Doe" required>
...
unset($__errorArgs, $__bag); ?>
                            ...
                            <div class="col-12">
                                ...
                                <textarea name="message" id="message" rows="5" class="form-control <?php $__errorArgs = ['message'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?> is-invalid <?php unset($message);
...
unset($__errorArgs, $__bag); ?>" placeholder="Write your message here..." required><?php echo e(old('message')); ?></textarea>
...
<?php echo $__env->make('layouts.app', array_diff_key(get_defined_vars(), ['__data' => 1, '__path' => 1]))->render(); ?><?php /**PATH D:\projectn_dark\resources\views/public/contact.blade.php ENDPATH**/ ?>