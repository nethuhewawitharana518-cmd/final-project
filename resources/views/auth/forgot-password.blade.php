...
@section('meta_description', 'Request a password reset link for your FoodRescue account.')
            ...
            <div class="col-md-5">
                <div class="card p-4 p-md-5 rounded-3" style="background: rgba(30, 30, 30, 0.85); backdrop-filter: blur(12px); border: 1px solid rgba(255,255,255,0.1); box-shadow: 0 25px 50px -12px rgba(0,0,0,0.7);">
                    ...
                    <div class="text-center mt-3">
                        <a href="{{ route('login') }}" class="text-primary small fw-semibold text-decoration-none"><i class="fa fa-arrow-left me-2"></i>Back to Login</a>
                    </div>
                </div>
            </div>
        </div>
