...
@section('meta_description', 'Learn about FoodRescue — an AI-powered marketplace in Trincomalee dedicated to reducing food waste and supporting the local community.')
        ...
        <div class="row g-4 justify-content-center">
            <div class="col-md-5">
                <div class="card h-100 border-0 shadow-sm p-4 text-center">
                    ...
                    <a href="{{ route('food.browse') }}" class="btn btn-success rounded-pill px-5 mt-auto">Browse Deals</a>
                </div>
            </div>
            <div class="col-md-5">
                <div class="card h-100 border-0 shadow-sm p-4 text-center">
                    ...
                    <a href="{{ route('register.business') }}" class="btn btn-outline-success rounded-pill px-5 mt-auto">Register Business</a>
                </div>
            </div>
        </div>
    </div>
