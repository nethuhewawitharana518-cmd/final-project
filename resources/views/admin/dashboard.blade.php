        ...
        <div class="content-area pt-2">
            <div class="grid-container">
                ...
                <div class="widget-card span-4" style="position: relative; min-height: 250px;">
                    ...
                    <div class="tooltip-marker">Rs. {{ number_format($totalRevenue) }}</div>
                ...
                <div class="widget-card span-4" style="min-height: 250px;">
                    <div class="d-flex justify-content-between align-items-center mb-3">
                        ...
                        <span class="text-white small fw-bold font-monospace" style="font-size: 11px; color: var(--dash-orange) !important;">{{ date('F Y') }}</span>
                    </div>
                    ...
                    <div class="d-flex w-100 justify-content-between">
                        <div class="stat-split w-50">
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div>
                                    <div style="font-size: 26px; font-weight: 800; color: #FFF; line-height: 1.2;">{{ $activeBusinessesCount ?? 0 }}</div>
                        ...
                        <div class="stat-split w-50">
                            <div class="d-flex align-items-center justify-content-between w-100">
                                <div>
                                    <div style="font-size: 26px; font-weight: 800; color: #FFF; line-height: 1.2;">{{ number_format($foodSavedKg ?? 0) }}</div>
                ...
                <div class="widget-card span-4" style="min-height: 250px; display: flex; flex-direction: column; justify-content: space-between;">
                    ...
                    <div>
                        <div style="font-size: 28px; font-weight: 800; color: #FFF;">{{ $usersCount ?? 0 }}</div>
                ...
                <div class="widget-card span-12">
                    <div class="d-flex justify-content-between align-items-center mb-4">
                        ...
                        <a href="{{ route('admin.businesses') }}" class="btn btn-outline-success btn-sm px-4">Manage Approvals</a>
                    </div>
                    ...
                    <div class="table-responsive">
                        <table class="table fr-table mb-0 align-middle">
                            ...
                            <tbody>
                                ...
                                <tr>
                                    <td class="fw-bold text-white">{{ $approval->business_name }}</td>
                                    <td>{{ $approval->user->name ?? 'N/A' }}</td>
                                    <td><span class="badge bg-secondary" style="border-radius: var(--radius-sm);">{{ ucfirst($approval->business_type) }}</span></td>
                                    <td><code>{{ $approval->reg_number }}</code></td>
                                    <td>{{ $approval->email }}</td>
                                    <td>
                                        <a href="{{ route('admin.businesses.show', $approval->id) }}" class="btn btn-sm btn-primary px-3">Review</a>
                                    </td>
                                </tr>
                                @empty
                                <tr>
